        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-16">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
              ...
              <div className="md:w-1/2">
                <img src="https://picsum.photos/600/400?random=1" alt="Team collaborating" className="rounded-lg shadow-lg" />
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row-reverse items-center gap-8 md:gap-12">
              ...
              <div className="md:w-1/2">
                <img src="https://picsum.photos/600/400?random=2" alt="Global network" className="rounded-lg shadow-lg" />
              </div>
            </div>
            ...
            <div className="text-center">
              ...
              <div className="aspect-w-16 aspect-h-9 max-w-4xl mx-auto bg-slate-900 rounded-lg shadow-lg flex items-center justify-center">
                ...
                <div className="text-center p-8">
                    <svg className="mx-auto h-16 w-16 text-slate-500" fill="currentColor" viewBox="0 0 24 24"><path d="M10 16.5l6-4.5-6-4.5v9zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"></path></svg>
                    <p className="mt-4 text-slate-400">Our Story: A video introduction to the i-Elite journey is coming soon.</p>
                </div>
              </div>
            </div>
          </div>
